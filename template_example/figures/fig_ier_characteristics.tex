...
% Top
\node[dia/rbox=3.5cm, minimum height=1.8cm] (int) at (90:5cm)
...
% Lower-left
\node[dia/rbox=3.5cm, minimum height=1.8cm] (ctx) at (234:5cm)
  {\textbf{Контекстуальність}\\[2pt]\scriptsize Ситуативне пізнання;\\експерієнціальне навчання};

% Lower-right
\node[dia/rbox=3.5cm, minimum height=1.8cm] (vis) at (306:5cm)
