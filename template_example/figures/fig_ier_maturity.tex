...
\node[dia/label, right=0.5cm of l0.east, text width=4cm, align=left] {${\sim}$10\,\% ЗВО};
\node[dia/label, right=0.5cm of l1.east, text width=4cm, align=left] {${\sim}$60\,\% ЗВО (більшість)};
\node[dia/label, right=0.5cm of l2.east, text width=4cm, align=left] {${\sim}$25\,\% ЗВО (ВНУ, ЧНУ, КДПУ, КрНУ)};
\node[dia/label, right=0.5cm of l3.east, text width=4cm, align=left] {${\sim}$5\,\% ЗВО (КДПУ)};
\node[dia/label, right=0.5cm of l4.east, text width=4cm, align=left] {Цільовий рівень (внесок дисертації)};
